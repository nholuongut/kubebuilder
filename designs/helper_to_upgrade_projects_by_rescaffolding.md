...
- See the discussion [How to regenerate scaffolding?](https://github.com/nholuongut/kubebuilder/discussions/2864)
...
Note that in the [e2e tests](https://github.com/nholuongut/kubebuilder/tree/master/test/e2e) the binary is used to do the scaffolds.
...
for further information check the [hack/docs](https://github.com/nholuongut/kubebuilder/tree/master/hack/docs).
...
be checked in this [pull request](https://github.com/nholuongut/kubebuilder/pull/3022)
...
in the past. We also tracked the [issue](https://github.com/nholuongut/kubebuilder/issues/2068)
