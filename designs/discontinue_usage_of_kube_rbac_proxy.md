...
That would mean, in a follow-up to the [current open PR](https://github.com/nholuongut/kubebuilder/pull/3853) to address the above `phase 1 - Transition to NetworkPolices`,
