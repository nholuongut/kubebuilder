...
* [#1148](https://github.com/nholuongut/kubebuilder/pull/1148)
* [#1171](https://github.com/nholuongut/kubebuilder/pull/1171)
* Possibly [#1218](https://github.com/nholuongut/kubebuilder/issues/1218)

## Prototype implementation

Barebones plugin refactor: https://github.com/joelanford/kubebuilder-exp
Kubebuilder feature branch: https://github.com/nholuongut/kubebuilder/tree/feature/plugins-part-2-electric-boogaloo
...
As discussed earlier as part of [#1148](https://github.com/nholuongut/kubebuilder/pull/1148), one goal is to eliminate the use of `cobra.Command` in the exported API of Kubebuilder since that is considered an internal implementation detail.
...
In [#1148](https://github.com/nholuongut/kubebuilder/pull/1148), callers would use Kubebuilder's cobra commands to build their CLI. Here, control of the CLI is retained by Kubebuilder, and callers pass their subcommands to Kubebuilder. This has several benefits:
