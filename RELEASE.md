...
For more info, see the release page: https://github.com/nholuongut/kubebuilder/releases/tag/v3.5.0
...
see: https://github.com/nholuongut/kubebuilder/discussions/4082
...
The build is made from the branch [tools-releases](https://github.com/nholuongut/kubebuilder/tree/tools-releases) and the trigger will call the `build/cloudbuild_tools.yaml` passing
...
For further information see the [README](https://github.com/nholuongut/kubebuilder/blob/tools-releases/README.md).
...
see: https://github.com/nholuongut/kubebuilder/discussions/3907
...
[kube-rbac-proxy-releases](https://github.com/nholuongut/kubebuilder/tree/kube-rbac-proxy-releases)
then the `build/cloudbuild_kube-rbac-proxy.yaml` will generate the images.

To check an example, see the pull request [#2578](https://github.com/nholuongut/kubebuilder/pull/2578).
...
These images are used to verify the PR title and description. They are built from [nholuongut/kubebuilder-release-tools](https://github.com/nholuongut/kubebuilder-release-tools/).
...
```yaml
  verify:
    ...
    - name: Verifier action
      id: verifier
      uses: nholuongut/kubebuilder-release-tools@v0.1.1
      with:
...
[kubebuilder-release-tools]: https://github.com/nholuongut/kubebuilder-release-tools
[release-notes-generation]: https://github.com/nholuongut/kubebuilder-release-tools/blob/master/README.md#release-notes-generation
[release-process]: https://github.com/nholuongut/kubebuilder/blob/master/VERSIONING.md#releasing
