...
- [kustomize](https://github.com/nholuongut/kustomize/blob/master/site/content/en/docs/Getting%20started/installation.md) v3.1.0+
...
![example](https://github.com/nholuongut/kubebuilder/assets/7708031/277d26d5-c94d-41f0-8f02-1381458ef750)
...
Current Kubebuilder provides the testing framework that includes testing code based on [ginkgo](https://github.com/onsi/ginkgo), [Github Actions](https://github.com/Kavinjsir/kubebuilder/blob/docs%2Ftest-plugin/.github/workflows/testdata.yml) for unit tests, and multiple env tests driven by [test-infra](https://github.com/kubernetes/test-infra/blob/master/config/jobs/nholuongut/kubebuilder/kubebuilder-presubmits.yaml).

To fully test the proposed plugin:

1. Create a new package(folder) under `test/e2e/<your-plugin>`.
2. Create [e2e_suite_test.go](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/v4/e2e_suite_test.go), which imports the necessary testing framework.
3. Create `generate_test.go` ([ref](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/v4/generate_test.go)). That should:
   - Introduce/Receive a `TextContext` instance
   - Trigger the plugin's bound subcommands. See [Init](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L213), [CreateAPI](https://github.com/nholuongut/kubebuilder/blob/v3.6.0/test/e2e/utils/test_context.go#L222)
   - Use [PluginUtil](https://pkg.go.dev/sigs.k8s.io/kubebuilder/v4/pkg/plugin/util) to verify the scaffolded outputs. See [InsertCode](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/pkg/plugin/util/util.go#L67), [ReplaceInFile](https://github.com/nholuongut/kubebuilder/blob/v3.6.0/pkg/plugin/util/util.go#L196), [UncommendCode](https://github.com/nholuongut/kubebuilder/blob/v3.6.0/pkg/plugin/util/util.go#L86)
4. Create `plugin_cluster_test.go` ([ref](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/v4/plugin_cluster_test.go)). That should:

   - 4.1. Setup testing environment, e.g:

     - Cleanup environment, create temp dir. See [Prepare](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L97)
     - If your test will cover the provided features then, ensure that you install prerequisites CRDs: See [InstallCertManager](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L138), [InstallPrometheusManager](https://github.com/nholuongut/kubebuilder/blob/v3.6.0/test/e2e/utils/test_context.go#L171)

   - 4.2. Run the function from `generate_test.go`.

   - 4.3. Further make sure the scaffolded output works, e.g:

     - Execute commands in your `Makefile`. See [Make](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L240)
     - Temporary load image of the testing controller. See [LoadImageToKindCluster](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L283)
   ...
   - 4.4. Delete temporary resources after testing exited, e.g:
     - Uninstall prerequisites CRDs: See [UninstallPrometheusOperManager](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L183)
     - Delete temp dir. See [Destroy](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/utils/test_context.go#L255)

5. Add the command in [test/e2e/plugin](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/e2e/setup.sh#L65) to run your testing code:
...
- [test/testdata/generated.sh](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/test/testdata/generate.sh#L144)
- [make generate](https://github.com/nholuongut/kubebuilder/blob/v3.7.0/Makefile#L70)
...
[For instance](https://github.com/nholuongut/kubebuilder/commit/0b36d0c4021bbf52f29d5a990157466761ec180c):
...
2. Note that the prow tests used in the CI are configured in [nholuongut/kubebuilder/kubebuilder-presubmits.yaml](https://github.com/kubernetes/test-infra/blob/master/config/jobs/nholuongut/kubebuilder/kubebuilder-presubmits.yaml).
