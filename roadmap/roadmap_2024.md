...
**References:**
- [Issue - Deprecations in Controller-Runtime and Impact on Webhooks](https://github.com/nholuongut/kubebuilder/issues/3721) - An issue detailing the deprecations in controller-runtime that affect Kubebuilder's approach to webhooks.
- [PR - Update to Align with Latest Controller-Runtime Webhook Interface](https://github.com/nholuongut/kubebuilder/pull/3399) - A pull request aimed at updating Kubebuilder to match controller-runtime's latest webhook interface.
- [PR - Enhancements to Controller Scaffolding for Upcoming Controller-Runtime Changes](https://github.com/nholuongut/kubebuilder/pull/3723) - A pull request proposing enhancements to Kubebuilder's controller scaffolding in anticipation of upcoming changes in controller-runtime.
...
see [GitHub Pull Request #3632](https://github.com/nholuongut/kubebuilder/pull/3632).
...
- **kube-rbac-proxy Images:**  :white_check_mark: Complete. ([More info](https://github.com/nholuongut/kubebuilder/discussions/3907))
...
- **PR Check image:**  🙌 Seeking Contributions to do the required changes - See that the images used to check the PR titles are also build and promoted by the Kubebuilder project in GCP but are from the project: https://github.com/nholuongut/kubebuilder-release-tools. The plan in this case is to use the e2e shared infrastructure. [More info](https://github.com/kubernetes/k8s.io/issues/2647#issuecomment-2111182864)
...
[here](https://github.com/nholuongut/kubebuilder/blob/master/RELEASE.md#to-build-the-kube-rbac-proxy-images).
...
available [here](https://github.com/nholuongut/kubebuilder/blob/master/RELEASE.md#to-build-the-kubebuilder-tools-artifacts-required-to-use-env-test).
...
**Status:** :white_check_mark: Complete but :raised_hands: Seek Contributors and help with the next steps, see: https://github.com/nholuongut/kubebuilder/issues/3871
...
- **Resolution**: The usage of kube-rbac-proxy has been discontinued from the default scaffold. We plan to provide other helpers to protect the metrics endpoint. Furthermore, once the project is accepted under kubernetes-sig or kubernetes-auth, we may contribute to its maintainer in developing an external plugin for use with projects built with Kubebuilder.
   - **Proposal**: [https://github.com/nholuongut/kubebuilder/blob/master/designs/discontinue_usage_of_kube_rbac_proxy.md](https://github.com/nholuongut/kubebuilder/blob/master/designs/discontinue_usage_of_kube_rbac_proxy.md)
   - **PR**: [https://github.com/nholuongut/kubebuilder/pull/3899](https://github.com/nholuongut/kubebuilder/pull/3899)
   - **Communication**: [https://github.com/nholuongut/kubebuilder/discussions/3907](https://github.com/nholuongut/kubebuilder/discussions/3907)
...
For more insights into these challenges, see [Issue #3524](https://github.com/nholuongut/kubebuilder/issues/3524).
...
[kube-rbac-proxy images—due](https://github.com/nholuongut/kubebuilder/blob/master/RELEASE.md#to-build-the-kube-rbac-proxy-images)
...
- Address kube-rbac-proxy breaking changes/deprecations.
  - For further information: [Issue #3524 - kube-rbac-proxy warn about deprecation and future breaking changes](https://github.com/nholuongut/kubebuilder/issues/3524)
- Feedback from the community has highlighted a preference for cert-manager's default integration, aiming security with Prometheus and metrics.
  - More info: [GitHub Issue #3524 - Improve scaffolding of ServiceMonitor](https://github.com/nholuongut/kubebuilder/issues/3657)
- Desire for kube-rbac-proxy to be optional, citing its prescriptive nature.
  - See: [Issue #3482 - The kube-rbac-proxy is too opinionated to be opt-out.](https://github.com/nholuongut/kubebuilder/issues/3482)
- Reduce the maintainability effort to generate the images used by Kubebuilder projects and dependency within third-party solutions.
  - Related issues:
    - [Issue #1885 - use a NetworkPolicy instead of kube-rbac-proxy](https://github.com/nholuongut/kubebuilder/issues/1885)
    - [Issue #3230 - Migrate away from google.com gcp project kubebuilder](https://github.com/nholuongut/kubebuilder/issues/3230)
...
**Status:** : ✅ Complete - Release was done
  - **Remove Deprecations**:https://github.com/nholuongut/kubebuilder/issues/3603
  - **Bump Module**: https://github.com/nholuongut/kubebuilder/pull/3924
...
and concise information, eliminating any confusion for users. **More Info:** [GitHub Discussion #3622](https://github.com/nholuongut/kubebuilder/discussions/3622)
